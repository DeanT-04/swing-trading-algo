...
if ($testMode) {
    ...
    python "$scriptDir\day_trading_main.py" --mode "paper" --config "$scriptDir\config\best_config_95plus_20250418_223546.yaml" --symbols "AAPL,MSFT,GOOGL,AMZN,META" --timeframe $timeframe --strategy "multi_timeframe" --duration 1.0
...
python "$scriptDir\day_trading_main.py" --mode "paper" --config "$scriptDir\config\best_config_95plus_20250418_223546.yaml" --symbols $symbols --timeframe $timeframe --strategy "multi_timeframe" --duration 6.5
